...
export default class MatDataTableMatch extends Component {
  constructor(props) {
    super(props);
    this.state = { person: [] };
  }
  ...
  componentDidMount(prevProps) {
    // const maxResults = 20;
    const url = `http://localhost/penzi/adminApi/allMatchLog.php`;
      ...
      <div style={{ maxWidth: "200%", marginLeft: "30px", marginTop: "100px", fontSize:"14px" }}>
        <MaterialTable
          ...
          columns={[
            ...
            { title: " searcher", field: "searcher" },
            { title: "searched", field: "searched" },
